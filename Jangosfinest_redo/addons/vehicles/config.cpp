...
class cfgVehicles
{
	...
	class JA_104th_VWing : 3as_Vwing_base{
		...
		class Components
		{
			...
			class TransportPylonsComponent
			{
				UIPicture = QPATHTOEF(vehicles,data\textures\plane_vwing_pylon_ca.paa);
				class pylons
				{
					class pylons1
					{
	...
	class JA_104th_V19_Torrent : 3as_V19_base{
		...
		class TextureSources
		{
			...
			class Blue: ME
			{
				displayName = "Blue";
				textures[] = {
					QPATHTOEF(vehicles,data\textures\wings_CO_104.paa), 
					QPATHTOEF(vehicles,data\textures\wing_plates_CO_104.paa), 
					QPATHTOEF(vehicles,data\textures\Hull_CO_104.paa), 
					"3as\3as_v19\textures\gun gear_co.paa",
					"a3\air_f_jets\plane_fighter_01\data\fighter_01_glass_01_ca.paa",
					"3as\3as_v19\textures\pizzlepit_co.paa"
				};
	...
	class JA_104th_3AS_Reaper_Y_Wing : Aux212_3AS_Reaper_Y_Wing
	{
		...
		class Components
		{
			...
			class TransportPylonsComponent
			{
				UIPicture = QPATHTOEF(vehicles,data\textures\plane_ywing_pylon_ca.paa);
				class pylons
				{
					class pylons1
					{
	...
	class JA_104th_3AS_Reaper_Y_Wing_BlueLeader : JA_104th_3AS_Reaper_Y_Wing
	{
		...
		scopeArsenal = 2;
		scopeCurator = 2;
		hiddenselectionstextures[] = {QPATHTOEF(vehicles,data\textures\YWing_Body_BlueLeader.paa), "3as\3as_btlb\data\detail_co.paa", "3as\3as_btlb\data\interior_co.paa"};
		class TextureSources
		{
			class BlueLeader
			{
				...
				author = "Dak";
				textures[] = {
					QPATHTOEF(vehicles,data\textures\YWing_Body_BlueLeader.paa), 
			...
			class Blue: BlueLeader
			{
				displayName = "Blue";
				textures[] = {
					QPATHTOEF(vehicles,data\textures\YWing_Body_Blue.paa), 
					"3as\3as_btlb\data\detail_co.paa", 
					"3as\3as_btlb\data\interior_co.paa"
				};
			};
	...
	*/
	class JA_104th_NU : 3AS_Nuclass{
		...
		LockDetectionSystem = 2+4+8+16;
		incomingMissileDetectionSystem = 2+4+8+16;
		hiddenSelectionsTextures[] = {QPATHTOEF(vehicles,data\textures\nu\exterior_104_CO.paa), QPATHTOEF(vehicles,data\textures\nu\wings_104_CO.paa), QPATHTOEF(vehicles,data\textures\nu\interior_104_co.paa), QPATHTOEF(vehicles,data\textures\nu\cockpit_doors_104_co.paa)};
		class pilotCamera
		{
			class OpticsIn
			{
	...
	class JA_104th_Xian_Infantry : O_T_VTOL_02_infantry_dynamicLoadout_F
	{
		...
		class TextureSources
		{
			class White
			{
				...
				factions[] = {"104th_Guys"};
				textures[] = {QPATHTOEF(vehicles,data\textures\xian\xian_ext01_CO.paa), QPATHTOEF(vehicles,data\textures\xian\xian_ext02_CO.paa), QPATHTOEF(vehicles,data\textures\xian\xian_ext03_L_CO.paa), QPATHTOEF(vehicles,data\textures\xian\xian_ext03_R_CO.paa)};
			};
		};
		hiddenSelectionsTextures[] = {QPATHTOEF(vehicles,data\textures\xian\xian_ext01_CO.paa), QPATHTOEF(vehicles,data\textures\xian\xian_ext02_CO.paa), QPATHTOEF(vehicles,data\textures\xian\xian_ext03_L_CO.paa), QPATHTOEF(vehicles,data\textures\xian\xian_ext03_R_CO.paa)};
	...
	class JA_104th_Republic_Transport : 3AS_Republic_Transport_01{
		...
		hiddenselectionstextures[] = {QPATHTOEF(vehicles,data\textures\104_hs_ext_co.paa), "3as\3as_starships\data\hs_int_co.paa", "a3\air_f_jets\plane_fighter_01\data\fighter_01_glass_01_ca.paa"};
	};
	...
	class shieldtest : House_F
	{
		...
		model = QPATHTOEF(vehicles,data\models\ShieldSphereTest.p3d);
		hiddenSelections[] = {};
		scope = 2;
		class EventHandlers : DefaultEventhandlers
		{
	...
	class oryxshield : shieldtest
	{
		...
		model = QPATHTOEF(vehicles,data\models\OryxShield.p3d);
		hiddenSelections[] = {};
	};
	class oryxshieldvo : oryxshield
	{
		...
		model = QPATHTOEF(vehicles,data\models\OryxShieldvo.p3d);
		hiddenSelections[] = {};
	};
	class oryxshieldred : oryxshield
	{
		...
		model = QPATHTOEF(vehicles,data\models\OryxShieldRed.p3d);
		hiddenSelections[] = {};
	};
	class oryxshieldfb : oryxshield
	{
		...
		model = QPATHTOEF(vehicles,data\models\OryxShieldfb.p3d);
		hiddenSelections[] = {};
	};
	...
	class TX130shieldred : shieldtest
	{
		...
		model = QPATHTOEF(vehicles,data\models\TX130ShieldRed.p3d);
		hiddenSelections[] = {};
	};
	class ywingshield : shieldtest
	{
		displayname = "Y-Wing shield bubble";
		model = QPATHTOEF(vehicles,data\models\YWingShield.p3d);
		hiddenSelections[] = {};
		scope = 2;
	};
	class ywingshieldvo : shieldtest
	{
		...
		model = QPATHTOEF(vehicles,data\models\YWingShieldvo.p3d);
		hiddenSelections[] = {};
		scope = 2;
	};
	class ywingshieldfb : shieldtest
	{
		...
		model = QPATHTOEF(vehicles,data\models\YWingShieldfb.p3d);
		hiddenSelections[] = {};
		scope = 2;
	};
	class ywingshieldhb : shieldtest
	{
		...
		model = QPATHTOEF(vehicles,data\models\YWingShieldhb.p3d);
		hiddenSelections[] = {};
		scope = 2;
	};
	class ywingshieldred : shieldtest
	{
		...
		model = QPATHTOEF(vehicles,data\models\YWingShieldRed.p3d);
		hiddenSelections[] = {};
	};
	class z95shieldvo : shieldtest
	{
		displayname = "Z-95 shield bubble Visual";
		model = QPATHTOEF(vehicles,data\models\Z95Shieldvo.p3d);
		hiddenSelections[] = {};
		scope = 2;
	};
	class z95shieldfb : shieldtest
	{
		...
		model = QPATHTOEF(vehicles,data\models\Z95Shieldfb.p3d);
		hiddenSelections[] = {};
		scope = 2;
	};
	class z95shieldhb : shieldtest
	{
		...
		model = QPATHTOEF(vehicles,data\models\Z95Shieldhb.p3d);
		hiddenSelections[] = {};
		scope = 2;
	};
	class z95shieldred : shieldtest
	{
		...
		model = QPATHTOEF(vehicles,data\models\Z95ShieldRed.p3d);
		hiddenSelections[] = {};
	};
...
//   "B_Truck_01_Repair_F",
	...
	class JA_104th_Republic_HR_Bag : 3AS_Republic_HR_Bag{
		...
		hiddenSelectionsTextures[] =
			{
				QPATHTOEF(vehicles,data\textures\Backpack_E-Web_Greyscale.paa)};
		class assembleInfo
		{
			primary = 1;
			base = "";
...
class CfgFunctions{
	class JA_104th{
		...
		class guidedResupply{
			file = QPATHTOEF(vehicles,Script\501Resupply);
			class GURE_spawnResupply{
				file = QPATHTOEF(vehicles,Script\501Resupply\spawn_resupply.sqf);
			};
			class GURE_grplFired{
				file = QPATHTOEF(vehicles,Script\501Resupply\grpl_fired.sqf);
			};
		};
	};
};
...
class cfgSounds
{
	...
	class ShieldHit0
	{
		sound[] = {QPATHTOEF(vehicles,data\sounds\Shield\ShieldHit_0.ogg), 100, 1, 100};
		name = "ShieldHit0";
		titles[] = {"ShieldHit0"};
		duration = 1;
	};
	class ShieldHit1
	{
		sound[] = {QPATHTOEF(vehicles,data\sounds\Shield\ShieldHit_1.ogg), 100, 1, 100};
		name = "ShieldHit1";
		titles[] = {"ShieldHit1"};
		duration = 1;
	};
	class ShieldHit2
	{
		sound[] = {QPATHTOEF(vehicles,data\sounds\Shield\ShieldHit_2.ogg), 100, 1, 100};
		name = "ShieldHit2";
		titles[] = {"ShieldHit2"};
		duration = 1;
	};
	class ShieldHit3
	{
		sound[] = {QPATHTOEF(vehicles,data\sounds\Shield\ShieldHit_3.ogg), 100, 1, 100};
		name = "ShieldHit3";
		titles[] = {"ShieldHit3"};
		duration = 1;
	};
	class ShieldHit4
	{
		sound[] = {QPATHTOEF(vehicles,data\sounds\Shield\ShieldHit_4.ogg), 100, 1, 100};
		name = "ShieldHit4";
		titles[] = {"ShieldHit4"};
		duration = 1;
	};
	class IonCannon1
	{
		sound[] = {QPATHTOEF(vehicles,data\sounds\Shield\IonCannon1.ogg), 100, 1, 100};
		name = "IonCannon1";
		titles[] = {"IonCannon1"};
		duration = 3;
	};
