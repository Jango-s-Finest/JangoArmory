...
class CfgWeapons
{
	...
	class JA_Prowler_P2_Base_NCO_Helmet : ls_gar_barc_helmet
	{
		...
		hiddenSelectionsTextures[] = {QPATHTOEF(prowler_company,data\textures\Prowler_Armored_NCO_Helmet.paa),"\ls\core\addons\characters_clone_legacy\helmets\barc\data\visor_co.paa"}; // the file path to the texture
	};
	class JA_Prowler_P2_Base_NCO_Uniform : ls_gar_marshalCommander_uniform
	{
		...
		hiddenSelectionsTextures[] =
			{
				QPATHTOEF(prowler_company,data\textures\Prowler_Armored_NCO_Upper.paa),
				QPATHTOEF(prowler_company,data\textures\Prowler_Armored_NCO_Lower.paa)};
	...
	class JA_Prowler_P2_Base_Officer_Helmet : ls_gar_barc_helmet
	{
		...
		hiddenSelectionsTextures[] = {QPATHTOEF(prowler_company,data\textures\Prowler_Armored_Officer_Helmet.paa),"\ls\core\addons\characters_clone_legacy\helmets\barc\data\visor_co.paa"}; // the file path to the texture
	};
	class JA_Prowler_P2_Base_Officer_Uniform : ls_gar_marshalCommander_uniform
	{
		...
		hiddenSelectionsTextures[] =
			{
				QPATHTOEF(prowler_company,data\textures\Prowler_Armored_Officer_Upper.paa),
				QPATHTOEF(prowler_company,data\textures\Prowler_Armored_Officer_Lower.paa)};
		class ItemInfo : UniformItem
		{
			uniformModel = "-";
			scope = 2;
	...
	class JA_Prowler_P2_Base_Fenris_Helmet : ls_gar_barc_helmet
	{
		...
		hiddenSelectionsTextures[] = {QPATHTOEF(prowler_company,data\textures\Captain_Fenris_Helmet.paa),"\ls\core\addons\characters_clone_legacy\helmets\barc\data\visor_co.paa"}; // the file path to the texture
	};
	class JA_Prowler_P2_Base_Fenris_Uniform : ls_gar_marshalCommander_uniform
	{
		...
		hiddenSelectionsTextures[] =
			{
				QPATHTOEF(prowler_company,data\textures\Captain_Fenris_Upper.paa),
				QPATHTOEF(prowler_company,data\textures\Captain_Fenris_Lower.paa)};
		class ItemInfo : UniformItem
		{
			uniformModel = "-";
			scope = 2;
	...
	class JA_Prowler_P2_Base_Trooper_Helmet : ls_gar_barc_helmet
	{
		...
		hiddenSelectionsTextures[] = {QPATHTOEF(prowler_company,data\textures\Prowler_Armored_Trooper_Helmet.paa),"\ls\core\addons\characters_clone_legacy\helmets\barc\data\visor_co.paa"}; // the file path to the texture
	};
	class JA_Prowler_P2_Base_Trooper_Uniform : ls_gar_marshalCommander_uniform
	{
		...
		hiddenSelectionsTextures[] =
			{
				QPATHTOEF(prowler_company,data\textures\Prowler_Armored_Trooper_Upper.paa),
				QPATHTOEF(prowler_company,data\textures\Prowler_Armored_Trooper_Lower.paa)};
		class ItemInfo : UniformItem
		{
			uniformModel = "-";
			scope = 2;
	...
	class JA_Prowler_P2_Base_Medic_Helmet : ls_gar_barc_helmet
	{
		...
		hiddenSelectionsTextures[] = {QPATHTOEF(prowler_company,data\textures\Prowler_Armored_Medic_Helmet.paa),"\ls\core\addons\characters_clone_legacy\helmets\barc\data\visor_co.paa"}; // the file path to the texture
	};
	class JA_Prowler_ENG_Base_Helmet : ls_gar_engineer_helmet
	{
		...
		hiddenSelectionsTextures[] = {
			QPATHTOEF(prowler_company,data\textures\Prowler_ENG_Engineer_Helmet.paa),
	...
	class JA_Prowler_ENG_Officer_Helmet : ls_gar_engineer_helmet
	{
		...
		hiddenSelectionsTextures[] = {
			QPATHTOEF(prowler_company,data\textures\Prowler_ENG_Officer_Helmet.paa),
			"\ls\core\addons\characters_clone_legacy\helmets\engineer\data\light_co.paa",
			"\ls\core\addons\characters_clone_legacy\helmets\engineer\data\visor_co.paa"}; // the file path to the texture
	};
	class JA_Prowler_P2_Base_Medic_Uniform : ls_gar_marshalCommander_uniform
	{
		...
		hiddenSelectionsTextures[] =
			{
				QPATHTOEF(prowler_company,data\textures\Prowler_Armored_Medic_Upper.paa),
				QPATHTOEF(prowler_company,data\textures\Prowler_Armored_Medic_Lower.paa)};
		class ItemInfo : UniformItem
		{
			uniformModel = "-";
			scope = 2;
	...
	class JA_Prowler_P2_Base_Fenris_Armor : ls_gar_officer_vest
	{
		...
		hiddenSelectionsTextures[] =
			{
				QPATHTOEF(prowler_company,data\textures\fenriskama.paa)};
...
class CfgVehicles
{
	...
	class JA_104th_Base_P2_Prowler_NCO : lsd_gar_phase2_base
	{
		...
		hiddenSelectionsTextures[] = {QPATHTOEF(prowler_company,data\textures\Prowler_Armored_NCO_Upper.paa), QPATHTOEF(prowler_company,data\textures\Prowler_Armored_NCO_Lower.paa)};
	...
	class JA_104th_Base_P2_Prowler_Officer : lsd_gar_phase2_base
	{
		...
		editorSubcategory = "104th_Categ_Clones_Prowler";
		hiddenSelections[] = {"camo1", "camo2"};
		hiddenSelectionsTextures[] = {QPATHTOEF(prowler_company,data\textures\Prowler_Armored_Officer_Upper.paa), QPATHTOEF(prowler_company,data\textures\Prowler_Armored_Officer_Lower.paa)};
	...
	class JA_104th_Base_P2_Prowler_Fenris : lsd_gar_phase2_base
	{
		...
		editorSubcategory = "104th_Categ_Clones_Prowler";
		hiddenSelections[] = {"camo1", "camo2"};
		hiddenSelectionsTextures[] = {QPATHTOEF(prowler_company,data\textures\Captain_Fenris_Upper.paa), QPATHTOEF(prowler_company,data\textures\Captain_Fenris_Lower.paa)};
	...
	class JA_104th_Base_P2_Prowler_Trooper : lsd_gar_phase2_base
	{
		...
		editorSubcategory = "104th_Categ_Clones_Prowler";
		hiddenSelections[] = {"camo1", "camo2"};
		hiddenSelectionsTextures[] = {QPATHTOEF(prowler_company,data\textures\Prowler_Armored_Trooper_Upper.paa), QPATHTOEF(prowler_company,data\textures\Prowler_Armored_Trooper_Lower.paa)};
	...
	class JA_104th_Base_P2_Prowler_Medic : lsd_gar_phase2_base
	{
		...
		editorSubcategory = "104th_Categ_Clones_Prowler";
		hiddenSelections[] = {"camo1", "camo2"};
		hiddenSelectionsTextures[] = {QPATHTOEF(prowler_company,data\textures\Prowler_Armored_Medic_Upper.paa), QPATHTOEF(prowler_company,data\textures\Prowler_Armored_Medic_Lower.paa)};
