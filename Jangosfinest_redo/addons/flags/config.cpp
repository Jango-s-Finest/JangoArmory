...
class CfgWeapons
{
	...
	class JA_Flag_WolfPack : ace_flags_white
	{
		...
		ace_flags_texture = QPATHTOEF(flags,data\textures\flag_wolfpack_co.paa);
		author = "Dak";
	...
	class JA_Flag_Lancer : ace_flags_white
	{
		...
		ace_flags_texture = QPATHTOEF(flags,data\textures\Lancer_Flag.paa);
		author = "Dak";
	...
	class JA_Flag_Cerberus_1_1: ace_flags_white
	{
		...
		ace_flags_texture = QPATHTOEF(flags,data\textures\Cerberus_1-1_Flag.paa);
		author = "Dak";
	...
	class JA_Flag_Cerberus_1_4 : ace_flags_white
	{
		...
		ace_flags_texture = QPATHTOEF(flags,data\textures\Cerberus_1-4_Flag.paa);
		author = "Dak";
	...
	class JA_Flag_Talon : ace_flags_white
	{
		...
		ace_flags_texture = QPATHTOEF(flags,data\textures\Talon_Flag.paa);
		author = "Dak";
	...
	class JA_Flag_Cerberus_1_3 : ace_flags_white
	{
		...
		ace_flags_texture = QPATHTOEF(flags,data\textures\Cerberus_1-3.paa);
		author = "Dak";
	...
	class JA_Flag_Warhawk_2_1 : ace_flags_white
	{
		...
		ace_flags_texture = QPATHTOEF(flags,data\textures\Warhawk_2-1.paa);
		author = "Dak";
	...
	class JA_Flag_Warhawk_2_2 : ace_flags_white
	{
		...
		ace_flags_texture = QPATHTOEF(flags,data\textures\Warhawk_2-2.paa);
		author = "Dak";
