...
{
	sleep 60;
	private _null = [_unit] execVM "JA\jangos_Armory\addons\FSN\freestyleScripts\targetClass.sqf";
};
...
if(FSN_Debug) then
{
	...
	_t setMarkerTypeLocal "hd_destroy";
...
private _null = [_unit, position _refTarget, _x # 1] execVM "JA\jangos_Armory\addons\FSN\freestyleScripts\dropNuke.sqf";
breakOut "loop";
	}
	else
	{
