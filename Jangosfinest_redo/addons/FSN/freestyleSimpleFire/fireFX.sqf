...
private _obj = "Sign_Sphere10cm_F" createVehicleLocal (getPos (_this select 0));
private _radius = _this select 1;
private _lifetime = _this select 2;
...
private _flames = "#particlesource" createVehicleLocal [0,0,0];
...
private _sound = selectRandom ["A3\Sounds_F\sfx\fire2_loop.wss", "A3\Sounds_F\sfx\fire3_loop.wss", "A3\Sounds_F\sfx\fire1_loop.wss"];
[_obj, _radius * 12, _sound] spawn
{
