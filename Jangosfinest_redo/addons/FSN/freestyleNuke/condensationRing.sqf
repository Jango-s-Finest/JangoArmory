...
private _heigth = _this select 1;
private _radius = _this select 2;

private _obj = "Sign_Sphere10cm_F" createVehicleLocal [_pos select 0, _pos select 1, (_pos select 2) + _heigth];
//_pos = getPos _obj;
