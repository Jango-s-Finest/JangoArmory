...
private _radius1 = _this select 1;


private _allVehicles = nearestObjects [_blastPos ,["LandVehicles", "Air", "Ship"], _radius1 * 2]; //get affected vehicles

private _jammed = "HitAvionics"; 
