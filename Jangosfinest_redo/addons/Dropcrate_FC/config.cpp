...
class CfgSounds
{
    ...
    class FC_Release_crate
    {
        ...
        sound[] = {"JA\jangos_Armory\addons\Dropcrate_FC\Sounds\CrateRelease.ogg","db+0", 1.0};
        titles[] = {};
    };
    class FC_Hit_Echo
    {
        name = "FC_Hit_Echo";
        sound[] = {"JA\jangos_Armory\addons\Dropcrate_FC\Sounds\HitEcho.ogg","db+0", 1.0};
        titles[] = {};
    };
    class FC_Hit_Ground
    {
        name = "FC_Hit_Ground";
        sound[] = {"JA\jangos_Armory\addons\Dropcrate_FC\Sounds\HitGround.ogg","db+0", 1.0};
        titles[] = {};
    };
    class FC_Hit_Thud
    {
        name = "FC_Hit_Thud";
        sound[] = {"JA\jangos_Armory\addons\Dropcrate_FC\Sounds\HitThud.ogg","db+0", 1.0};
        titles[] = {};
    };
    class FC_Locator_fly
    {
        name = "FC_Locator_fly";
        sound[] = {"JA\jangos_Armory\addons\Dropcrate_FC\Sounds\Locator.ogg","db+0", 1.0};
        titles[] = {};
    };
    class FC_Crate_Fly
    {
        name = "FC_Crate_Fly";
        sound[] = {"JA\jangos_Armory\addons\Dropcrate_FC\Sounds\ThrustersFly.ogg","db+0", 1.0};
        titles[] = {};
    };
    class FC_Sputter_T
    {
        name = "FC_Sputter_T";
        sound[] = {"JA\jangos_Armory\addons\Dropcrate_FC\Sounds\ThrusterSputter.ogg","db+0", 1.0};
        titles[] = {};
    };
};
class CfgVehicles
{
	...
	class FC_Dropcrate_104th: ReammoBox
	{
		...
		model = "JA\jangos_Armory\addons\Dropcrate_FC\dropcrate_DP.p3d";
		maximumLoad = 4000;
		...
		{
			class _xx_ls_weapon_rps6_loadedP{
				count = 3;
...
class CfgNonAIVehicles
{
    ...
    {
        model = "JA\jangos_Armory\addons\Dropcrate_FC\Dropcrate_closed.p3d";
