...
class CfgVehicles
{
	...
	class JA_104th_Backpack_Invis : ls_gar_survival_backpack
	{
		...
		hiddenSelectionsTextures[] =
			{
				""};
		maximumLoad = 250; // In LBS (320 = 32 lbs original, 400 = 40 lbs)
	};
	...
	class JA_104th_Accessories_Rocket_Backpack : ls_gar_heavy_backpack
	{
		author = "Tundra";
		scopeCurator = 2;
		displayname = "Clone Trooper Rocket backpack (104th)";
		maximumLoad = 450;
		model = "\ls\core\addons\characters_clone_legacy\backpacks\standard_old\ls_gar_standard_backpack_old.p3d";
		hiddenSelections[] = {"camo1","cover","heavy","medic","RTO"};
		hiddenSelectionsTextures[] =
	...
	class JA_104th_RTO_Mini_Tiger_Backpack : ls_gar_rto_mini_backpack
	{
		author = "Tundra";
		scopeCurator = 2;
		displayname = "Clone Trooper RTO mini backpack (104th Tiger)";
		maximumLoad = 250;
		hiddenSelectionsTextures[] =
			{
	...
	class JA_104th_RTO_Mini_Knockout_Backpack : ls_gar_rto_mini_backpack
	{
		author = "Tundra";
		scopeCurator = 2;
		displayname = "Clone Trooper RTO mini backpack (104th Knockout)";
		maximumLoad = 250;
		hiddenSelectionsTextures[] =
			{
