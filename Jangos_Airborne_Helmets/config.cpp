...
class CfgWeapons
{
	...
	class JA_104th_Carmine_Helmet : SWLB_clone_AB_helmet
	{
		...
		hiddenSelectionsTextures[] = { "Jangos_Airborne_Helmets\data\Textures\104th_AB_Carmine_Helmet.paa" }; // the file path to the texture
	};
	...
	class JA_104th_Achilles_Helmet : SWLB_clone_AB_helmet
	{
		...
		hiddenSelectionsTextures[] = { "Jangos_Airborne_Helmets\data\Textures\104th_AB_Achilles_Helmet.paa" }; // the file path to the texture
	};
