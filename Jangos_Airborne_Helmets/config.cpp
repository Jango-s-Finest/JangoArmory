...
class CfgWeapons
{
	...
	class JA_104th_AB_Squid_Helmet : ls_gar_airborne_helmet
	{
		...
		subItems[] = {"Integrated_NVG_TI_0_F"};
		hiddenSelectionsTextures[] = {"Jangos_Airborne_Helmets\data\Textures\104th_AB_Squid_Helmet.paa","Jangos_Airborne_Helmets\data\Textures\104th_AB_Squid_Helmet.paa"}; // the file path to the texture
	};
	...
	class JA_104th_Artorias_Helmet : ls_gar_airborne_helmet
	{
		...
		subItems[] = {"Integrated_NVG_TI_0_F"};
		hiddenSelectionsTextures[] = {"Jangos_Airborne_Helmets\data\Textures\104th_AB_Artorias_Helmet.paa","Jangos_Airborne_Helmets\data\Textures\104th_AB_Artorias_Helmet.paa"}; // the file path to the texture
	};
	...
	class JA_104th_Six_Helmet : ls_gar_airborne_helmet
	{
		...
		subItems[] = {"Integrated_NVG_TI_0_F"};
		hiddenSelectionsTextures[] = {"Jangos_Airborne_Helmets\data\Textures\104th_AB_Six_Helmet.paa","Jangos_Airborne_Helmets\data\Textures\104th_AB_Six_Helmet.paa"}; // the file path to the texture
	};
