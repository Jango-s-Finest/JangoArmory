class CfgPatches
{
	class Jangos_Armory_Vehicles
	{
		...
		weapons[] = {};
		requiredVersion = 0.1;
		requiredAddons[] = {"A3_Air_F_EPB_Heli_Light_03","A3_Armor_F_Beta", "A3_Soft_F"};
	};
};
...
class cfgVehicles {
	...
	class 104th_APC_Light_Bantha: 212th_B_APC_Wheeled_02_cannon_F
	{
	...
	class 104th_LSV: O_T_LSV_02_armed_F
	{
