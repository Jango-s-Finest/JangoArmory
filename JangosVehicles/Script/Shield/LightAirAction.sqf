...
_vic addAction [
        "Enable Shield",
        {
			...
			[_target, ["shield_bootup", 200, 1, 1]] remoteExec ["say3D"];
            ...
            [_target, ["shield_broken", 200, 1, 1]] remoteExec ["say3D"];
            ...
            sleep 60;
            [_target] execVM "\JangosVehicles\Script\Shield\LightAirAction.sqf";
        },
