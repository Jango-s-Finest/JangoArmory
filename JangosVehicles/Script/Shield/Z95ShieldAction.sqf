...
_vic addAction [
        "Enable Shield",
        {
            ...
            private _shield = "z95shieldvo" createVehicle [0,0,0];
            _shield attachTo [_target,[0,-0.7,-0.3]];
            _shield setDir 0;
			
			private _flash = "z95shieldred" createVehicle [0,0,0];
            _flash attachTo [_target,[0,-0.7,-0.3]];
            _flash setDir 0;
            ...
            sleep 60;
            [_target] execVM "\JangosVehicles\Script\Shield\Z95ShieldAction.sqf";
        },
