...
if (isServer) then {
_vic setVariable ["104thVicShieldStrength", 2000, true];
...
_vic addEventHandler ["HitPart", { 
				...
				_shieldhealth = (_shieldadjust / 20);
...
[_vic] execVM "\JangosVehicles\Script\Shield\RTShieldAction.sqf";

[_vic] execVM "\JangosVehicles\Script\Shield\BigVicShieldRegen.sqf";