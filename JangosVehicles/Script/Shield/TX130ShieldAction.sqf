...
_vic addAction [
        "Enable Shield",
        {
            ...
            private _shield = "TX130shieldvo" createVehicle [0,0,0];
            _shield attachTo [_target,[0,0,-2.5]];
            _shield setDir 0;
			
			for "_i" from 0 to 5 do {
            private _flash = "TX130shieldred" createVehicle [0,0,0];
            _flash attachTo [_target,[0,0,-2.5]];
            _flash setDir 0;
            sleep 0.1;
            ...
            sleep 60;
            [_target] execVM "\JangosVehicles\Script\Shield\TX130ShieldAction.sqf";
        },
